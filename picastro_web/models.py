...
class Post(models.Model):
    ...
    poster = models.ForeignKey(User, related_name="custom_post_profile", on_delete=models.CASCADE)
...
class Equipment(models.Model):
    ...
    userId = models.ForeignKey(User, related_name="custom_equipment_profile", on_delete=models.CASCADE)
...
class ImageIsSaved(models.Model):
    userId= models.ForeignKey(User, related_name="custom_imageIsSaved_profile", on_delete=models.CASCADE)
...
class savedImages(models.Model):
    userId= models.ForeignKey(User, related_name="savedImages", on_delete=models.CASCADE)
